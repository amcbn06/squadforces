...
- **Hints and notes per problem.** A group's owner (or the admin) has separate buttons to add hints, solutions and notes; members leave notes, each with a self-reported time-to-solve.
